...
import { styles } from './edit_banner_profile_dialog_styles';
...
const EditProfileImageDialogComponent = ({ open, onClose, onChange }) => {
...
export const EditProfileImageDialog = EditProfileImageDialogComponent;
